...
using DrawPub.ImageService.Models;
using DrawPub.ImageService.Results;
    ...
    public class AccountController : ApiController
    {
       // private AuthRepository _repo = null;
        ...
        public async Task<IHttpActionResult> Register(UserModel userModel)
        {
            ...
            return Ok("User is registered now");
        }
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            //   IdentityUser user = await _repo.FindAsync();

            var user =  new UserLoginInfo(provider, verifiedAccessToken.user_id);
            ...
            //generate access token response
            var accessTokenResponse = GenerateLocalAccessTokenResponse(user.ProviderKey);//user.UserName);
